...
It was originally written to run on a UniFi CloudKey Gen2 Plus so is built to be as lightweight as possible with a single goal, _always answer the call_ to boot your servers.
