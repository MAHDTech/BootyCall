...
Both fonts shipped with BootyCall are licensed under the SIL Open Font
License, Version 1.1. The OFL requires the license text to travel with
the font files, hence this document.

## Lato-Regular.ttf

Copyright (c) 2010–2015, Łukasz Dziedzic (<dziedzic@typoland.com>),
with Reserved Font Name "Lato". Homepage: <https://www.latofonts.com/>.

Licensed under the SIL Open Font License, Version 1.1 (see full text
below).

## Rajdhani-Bold.ttf

Copyright (c) 2014, Indian Type Foundry
(<info@indiantypefoundry.com>), with Reserved Font Name "Rajdhani".
